    ...
    <main className='grid min-h-screen place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8'>
      <div className='text-center'>
        ...
        <div className='gap-6 mt-10 flex flex-col items-center justify-between sm:flex-row max-w-xs mx-auto'>
          <span
            onClick={() => navigate(-1)}
            className='cursor-pointer rounded-md no-underline bg-primary-600 mx-2 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-primary-600'
          >
            Go back
          </span>
          <Link
